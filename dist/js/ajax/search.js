document.getElementById('ajax').addEventListener('input', function () {
    ...
    if (search.trim() === '') { // Verifica se o campo de pesquisa está vazio
        xhr.open('GET', 'App/Controler/TodosRamais/Search.php', true); // Requisição para buscar todos os resultados
    } else {
        xhr.open('GET', 'App/Controler/TodosRamais/Search.php?ajax=' + search, true); // Requisição para buscar os resultados da pesquisa
    }
    xhr.send();
});
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column item">
                <div class="card bg-light d-flex flex-fill">
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="lead"><b>${resultado.nome}</b></h2>
                                <p class="text-muted text-sm"><b>Setor:</b>${resultado.setor}</p>
